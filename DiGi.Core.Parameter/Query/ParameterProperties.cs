...
namespace DiGi.Core.Parameter
{
    public static partial class Query
    {
        ...
        /// <returns>The <see cref="ParameterProperties"/> associated with the specified enumeration, or <c>null</c> if not found.</returns>
        ...
        /// <returns>The <see cref="ParameterProperties"/> associated with the specified type and text, or <c>null</c> if not found.</returns>
